...
export default function page() {
    return (
        <article className="prose">
            ...
            <h2>导言</h2>
            <p>
                <a href="https://labs.coolha.com" target='_blank' className=" hover:link-hover text-primary">labs.coolha.com</a> 是由 <b>酷哈实验室</b> （以下简称“我们”）开发提供的门户网站。<a href="https://coolha.com" target='_blank' className=" hover:link-hover text-primary">coolha.com</a>是我们开发提供的产品。
                您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。
                本《隐私政策》与您所使用的 <i>labs.coolha.com</i> 网站服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
            </p>
