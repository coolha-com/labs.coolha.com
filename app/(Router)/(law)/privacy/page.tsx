...
export default function page() {
    return (
        <article className="prose">
            <h1>隐私政策</h1>
            <div>更新日期：<strong>2024/12/04</strong></div>
            <div>生效日期：<strong>2024/12/04</strong></div>
            <h2>导言</h2>
            <p>
                <a href="https://about.coolha.com" target='_blank' className=" hover:link-hover text-primary">about.coolha.com</a> 是由 <b>酷哈工作室</b> （以下简称“我们”）开发提供的门户网站。<a href="https://coolha.com" target='_blank' className=" hover:link-hover text-primary">coolha.com</a>是我们开发提供的产品。
                您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。
                本《隐私政策》与您所使用的 <i>about.coolha.com</i> 网站服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
            </p>
            <p><strong>您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。</strong></p>
            <p>如对本《隐私政策》或相关事宜有任何问题，请通过 <span className=" text-primary">fqa@coolha.com</span> 与我们联系。</p>
            ...
            <ul>
                <li>我们会通过安全的方式存储您的信息，包括本地存储（例如进行数据缓存）、数据库和服务器日志。</li>
                <li>一般情况下，我们只会在为实现服务目的所必需的时间内或法律法规规定的条件下存储您的个人信息。</li>
            </ul>

            <strong>2.2 信息存储的地域</strong>
            <ul>
                <li>我们会按照法律法规规定，将收集的用户个人信息存储于 vercel.com 云服务商和集成商。</li>
            </ul>
